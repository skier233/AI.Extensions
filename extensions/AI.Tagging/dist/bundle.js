          ...
          h("table", { className: "min-w-full border-collapse text-sm" }, [
            ...
            h("tbody", { key: "body" }, rows.map((override, index) => h("tr", {
              ...
              h("td", { className: "px-3 py-2" }, [
                h("input", {
                  className: "w-full min-w-[12rem] rounded-md border border-border bg-background px-2 py-1.5 text-sm text-foreground outline-none focus:border-accent",
              ...
              h("td", { className: "px-3 py-2" }, [
                h("input", {
                  className: "w-full min-w-[14rem] rounded-md border border-border bg-background px-2 py-1.5 text-sm text-foreground outline-none focus:border-accent",
